...
export default function FeaturesPage() {
  ...
  const features = [
    {
      num: '01', label: 'AI LENDER MATCHING',
    ...
    {
      num: '03', label: 'AI BANK STATEMENT ANALYSIS',
      ...
      bullets: [
        'LlamaParse OCR with 97%+ extraction accuracy',
        'Gemini AI enrichment for risk signal detection',
    ...
    {
      num: '05', label: 'COMPLETE AUDIT TRAIL',
  ...
  return (
    <>
      ...
      <section className="section section-alt">
        <div className="container">
          ...
          <div className="grid-4">
            {[
              { icon: '🔄', title: 'Renewal Forecasting', desc: 'Daily alerts 60 days before 50% paydown — the optimal renewal window.' },
              { icon: '📦', title: 'Deal Package Generation', desc: 'PDF deal packages with mailto drafts for lender submission.' },
              { icon: '🔗', title: 'Merchant Upload Portal', desc: 'Token-gated upload links for merchants to submit docs directly.' },
              { icon: '📊', title: 'Analytics Dashboard', desc: 'Portfolio, Industry, Lender Intel, and AI Predictions — four purpose-built views.' },
              { icon: '👥', title: 'Team Management', desc: 'Owner, Admin, Rep roles with granular permission controls.' },
              { icon: '🔔', title: 'Smart Notifications', desc: 'Real-time alerts for offers, expirations, and status changes.' },
      ...
      <CTABanner headline="See it in action." sub="Start your 14-day free trial and run your first AI-scored deal in under 10 minutes." />
    </>
  );
}
