        ...
        <div className="container">
          ...
          <div className="reveal">
            <div className="screenshot screenshot-elevated">
              <Image src="/images/Underwriting-Intelligence.png" alt="Intelligence Dashboard" width={1400} height={800} priority />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section section-dark">
        <div className="container">
          ...
          <div className="grid-2">
            {[
              { event: 'Deal Funded', response: 'Relationship score strengthens. Renewal tracking begins. Commission recorded. Pull-through rate adjusts upward.', icon: (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M22 11.08V12a10 10 0 11-5.93-9.14" /><polyline points="22 4 12 14.01 9 11.01" /></svg>) },
              { event: 'Deal Declined', response: 'Temporary score penalty applied (-10% to -20%, 30-day expiry). Decline reason categorized. Future matches steered away.', icon: (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10" /><line x1="15" y1="9" x2="9" y2="15" /><line x1="9" y1="9" x2="15" y2="15" /></svg>) },
              { event: 'Lender Appetite Stale', response: 'Warning badge appears on lender. Broker prompted to update buybox. Match confidence drops until refreshed.', icon: (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z" /><line x1="12" y1="9" x2="12" y2="13" /><line x1="12" y1="17" x2="12.01" y2="17" /></svg>) },
              { event: 'Prediction Ages', response: 'Time-decay reduces weight automatically. 30d = full weight, 90d = 40%, 180d = 20%, >180d = 5%.', icon: (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10" /><polyline points="12 6 12 12 16 14" /></svg>) },
            ].map((item, i) => (
                ...
                <div className="intelligence__progressive-list">
                  {[
                    ...
                    <div key={i} className="intelligence__progressive-item">
                      <span className="intelligence__progressive-check"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12" /></svg></span> {req}
                    </div>
                  ))}
                </div>
