...
export default function IntelligencePage() {
  ...
  return (
    <>
        ...
        <div className="container">
          <div className="section-header center reveal">
            ...
            <h1 className="display-xl intelligence__hero-title">
              ...
              <br />
              One <em className="italic teal-gradient">compounding</em>{" "}
              advantage.
            </h1>
            <p className="text-lg intelligence__hero-sub">
              YieldStream doesn't just store data — it thinks. Every lender
              recommendation is computed from three distinct signal layers,
              weighted by your organization's unique history.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="section-header reveal">
            ...
            <p className="text-lg intelligence__section-sub">
              This is the data flywheel: more outcomes → better predictions →
              higher pull-through → more commissions → more outcomes.
            </p>
          </div>
          <div className="grid-2">
            {[
              ...
              <div
                key={i}
                className={`reveal reveal-delay-${(i % 2) + 1} intelligence__loop-card`}
              >
          ...
          <div className="grid-feature reveal">
            <div>
              ...
              <p className="text-lg intelligence__time-desc">
                Lender appetites shift. A funder who was aggressively buying
                restaurant deals in Q1 might have pulled back by Q3. YieldStream
                automatically de-prioritizes old data to keep every
                recommendation fresh and current.
              </p>
              <div
      ...
      <CTABanner
        headline="Experience the intelligence engine."
        sub="Run your first AI-scored deal and see the three-layer scoring in action."
      />
    </>
  );
}
