      ...
      <section style={{ padding: '80px 0 60px', background: 'var(--n50)' }}>
        <div className="container">
          <div className="section-header center reveal">
            ...
            <h1 className="display-xl" style={{ marginTop: 12 }}>30 minutes of manual review.<br />Replaced in <em className="italic teal-gradient">120 seconds.</em></h1>
      ...
      <section className="section">
        <div className="container">
          <div className="grid-feature reveal">
            <div>
              <div className="label" style={{ marginBottom: 12 }}>The 2-Minute Audit</div>
              <h2 className="display-md">From raw PDF to scored intelligence.</h2>
              <p className="text-md" style={{ marginTop: 12, marginBottom: 24 }}>
                ...
                {[
                  ...
                  <div key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: 16 }}>
                    <div className="mono" style={{
                      ...
                      background: i === 3 ? 'var(--a500)' : 'var(--p50)',
                      color: i === 3 ? 'white' : 'var(--p700)',
                      display: 'flex', alignItems: 'center', justifyContent: 'center',
                      fontSize: '0.75rem', fontWeight: 600, flexShrink: 0
                    }}>{i + 1}</div>
                    <div>
                      <div style={{ fontSize: '0.92rem', fontWeight: 600, color: 'var(--n800)' }}>{s.step}</div>
                      <div className="text-sm">{s.detail}</div>
                    </div>
                    <div className="mono" style={{ fontSize: '0.75rem', color: 'var(--n400)', marginLeft: 'auto', flexShrink: 0 }}>{s.time}</div>
                  </div>
                ))}
              </div>
            </div>
      ...
      <section className="section section-alt">
        <div className="container">
          <div className="section-header center reveal">
            ...
            <h2 className="display-lg" style={{ marginTop: 12 }}>Everything a human underwriter checks. Automatically.</h2>
          </div>
          <div className="grid-4">
            {[
              ...
              <div key={i} className={`card reveal reveal-delay-${(i % 4) + 1}`} style={{ padding: 20 }}>
                <h3 style={{ fontSize: '0.92rem', fontWeight: 600, marginBottom: 4 }}>{s.signal}</h3>
      ...
      <section className="section">
        <div className="container">
          <div className="grid-feature reveal">
            ...
            <div>
              <div className="label" style={{ marginBottom: 12 }}>The Underwriter's Note</div>
              ...
              <div style={{
                background: 'var(--p900)', borderRadius: 12, padding: 24, color: 'white',
              }}>
                <div className="mono" style={{ fontSize: '0.7rem', color: 'var(--a400)', letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: 10 }}>
                  ✎ Example Note
                </div>
      ...
      <section className="section section-alt">
        <div className="container">
          <div className="section-header reveal">
            ...
            <h2 className="display-lg" style={{ marginTop: 12 }}>See which lenders overlap — and which don't.</h2>
            <p className="text-lg" style={{ maxWidth: 600, margin: '16px auto 0' }}>
